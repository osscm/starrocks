...
public class AwsCloudConfigurationTest {
    ...
    public void testWebIdentityApplyToConfigurationWithAssumeRole() {
        ...
        Assert.assertEquals("com.starrocks.credential.provider.AssumedRoleCredentialProvider",
                configuration.get("fs.s3a.aws.credentials.provider"));
        Assert.assertEquals("arn:aws:iam::123456789:role/MyRole", configuration.get("fs.s3a.assumed.role.arn"));
    }
    ...
    public void testWebIdentityToFileStoreInfo() {
        ...
        Assert.assertTrue(fileStoreInfo.getS3FsInfo().getCredential().hasDefaultCredential());
    }
